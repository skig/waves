...
class GestureHandler:
    ...
    def __init__(self, script_path: str):
        spec = importlib.util.spec_from_file_location('_gesture_handler_script', script_path)
        if spec is None or spec.loader is None:
            raise ImportError(f'Cannot load gesture handler script: {script_path}')
        module = importlib.util.module_from_spec(spec)
        sys.modules['_gesture_handler_script'] = module
    ...
    def on_recognition_start(self, classes: list) -> None:
        ...
        try:
            ...
            print(f'[gesture_handler] error in on_recognition_start:')
            traceback.print_exc()
    ...
    def on_gesture(self, label: str, confidence: float, probabilities: dict) -> None:
        ...
        try:
            ...
            print(f'[gesture_handler] error in on_gesture:')
            traceback.print_exc()
    ...
    def on_recognition_stop(self) -> None:
        ...
        try:
            ...
            print(f'[gesture_handler] error in on_recognition_stop:')
            traceback.print_exc()


def load_gesture_handler(script_path: Optional[str]) -> Optional[GestureHandler]:
